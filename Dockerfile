...
RUN apk --update add ffmpeg python3 python3-tkinter psmisc openblas \
    && apk add --virtual .builddep openblas-dev gfortran python3-dev libffi-dev openssl-dev git curl build-base \
